...
type RightPaneTab = 'preview' | 'copilot'
...
export default function NewsletterStudio({
  ...
  const [rightPane, setRightPane] = useState<RightPaneTab>('preview')
  ...
  return (
    <div className="flex h-screen flex-col bg-[var(--background)]">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Right pane: tab-switched between live preview and AI co-pilot.
            Tabs sit at the top so the toggle is right next to the content
            it controls — keeps the studio header clean. */}
          ...
          <div className="flex shrink-0 items-stretch border-b border-[var(--border)]">
            <button
              ...
              className={`px-3 py-2 text-[10px] font-semibold uppercase tracking-widest transition-colors ${
                rightPane === 'preview'
                  ? 'border-b-2 border-primary-500 text-[var(--text)]'
            ...
            <button
              ...
              className={`flex items-center gap-1 px-3 py-2 text-[10px] font-semibold uppercase tracking-widest transition-colors ${
                rightPane === 'copilot'
                  ? 'border-b-2 border-primary-500 text-[var(--text)]'
                  : 'text-[var(--text-muted)] hover:text-[var(--text)]'
              }`}
                ...
                <div className="flex items-center border border-[var(--border)] bg-[var(--background-card)]" role="group" aria-label="Vorschau-Breite">
                  <button
                    ...
                    className={`px-2 py-0.5 transition-colors ${
                      viewport === 'desktop' ? 'bg-[var(--bg-secondary)] text-[var(--text)]' : 'text-[var(--text-muted)] hover:text-[var(--text)]'
                    }`}
                  ...
                  <button
                    ...
                    className={`px-2 py-0.5 transition-colors ${
                      viewport === 'mobile' ? 'bg-[var(--bg-secondary)] text-[var(--text)]' : 'text-[var(--text-muted)] hover:text-[var(--text)]'
                    }`}
