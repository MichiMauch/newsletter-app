      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="glass-card p-5">
          ...
          <div className="space-y-2">
            ...
            <Link href="/admin/newsletter/emails" className="flex w-full items-center gap-3 border border-[var(--border)] p-3 text-left text-sm font-medium text-[var(--text)] transition-colors hover:border-[var(--text-secondary)]">
              <svg className="h-4 w-4 text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
              E-Mail-Templates ansehen
            </Link>
          </div>
        </div>
