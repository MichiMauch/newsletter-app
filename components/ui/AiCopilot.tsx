...
export default function AiCopilot({ context }: AiCopilotProps) {
  ...
  return (
    <div className="fixed bottom-4 right-44 z-[9997] flex flex-col items-end gap-2">
      {open && (
        <div className="w-96 max-w-[90vw] border border-[var(--border)] bg-[var(--background-elevated)] shadow-xl">
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        aria-label="AI Co-Pilot öffnen"
        title="AI Co-Pilot"
        className="flex items-center gap-2 border border-primary-300 bg-primary-50 px-3 py-1.5 text-xs font-medium text-primary-700 shadow-md transition-colors hover:bg-primary-100 dark:border-primary-700 dark:bg-primary-900/40 dark:text-primary-200 dark:hover:bg-primary-900/60"
      >
